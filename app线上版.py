...
4. 【防误判机制（极其重要）】：包含敏感词（如“加盟商”、“警察”）不代表发生了敏感事件。必须进行【事实核查】：
   ...
   - ⚠️注意分级核查：高危标签（S/A/B级）必须对应“已发生的客观严重事件或客诉”；但对于【产品口味、常规服务体验】等主观吐槽（如“难喝”、“没味道”），必须正常匹配 C/D 级标签，绝对不可视为无负面！
   - 注意：以“为什么...”等疑问句式来表达对产品、包装、收费、服务等方面不满的（例如：“为什么收打包费却不给保温袋？”），属于隐性客诉，必须按实质负面内容进行定级，不能算作常规疑问！
   - 高危标签（S/A级）必须对应“已发生的客观严重事件”。
5. 【特殊情况判定与输出规则】
如果研判发现该舆情事件仅仅是无意义的玩梗调侃、或者纯粹的正面评价/常规疑问，且没有任何对产品口味、服务、包装的抱怨与吐槽：
绝对禁止生搬硬套...必须立即终止...并输出 R。
